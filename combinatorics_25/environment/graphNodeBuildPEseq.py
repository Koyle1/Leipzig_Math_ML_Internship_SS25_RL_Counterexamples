...
def calc_reward_nx(G: nx.Graph, penalty:float = 0.0): #Penalty not used in this version
    ...
    # Add small monotonic term to encourage connectivity without changing max location
    connected_boost = np.log1p(lambda_2)  # log(1 + λ₂), smooth and ∂-able (boundary funciton)
