...
from model.dd_explors import DD_ExplorerModel
...
def main():
    ...
    parser.add_argument("--enviroment", type=str, default="graphNodeBuildPEseqBoundaryDD-v0", help="Choose an enviorment")
    parser.add_argument("--model", type=str, default="PPO", help="Choose an algorithm")
    parser.add_argument("--n_env", type=int, default=32, help="number of parallel enviroments")
    ...
    m = DD_ExplorerModel(model_name=args.model,
                     env=env,
                     seed=seed)
    try:
